...
function Option() {
  return (
    <div className="options__container flex flex-wrap  mb-4">
      ...
      <div className="option mt-2 sm:mt-4 bg-[var(--color-btn-sun)] hover:bg-pink-500 dark:bg-pink-900 dark:hover:bg-pink-500 duration-200 ease-in w-fit flex items-center rounded-md py-2 px-4 hover:cursor-pointer ">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
